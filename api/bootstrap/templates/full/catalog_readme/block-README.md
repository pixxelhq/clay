...
Please provide a complete overview of the block, like:
...
1. Provide block details below along with a "sample_input.png" and "sample_output.png" in
...
3. Once you've written the README document, please use the following command with the Clay CLI to upload it to S3:
    - ensure you are at the root of block folder
    - run `clay upload readme -n name -v version` . The command returns a catalog_content_url
    - Update the catalog_content_url in block spec file
