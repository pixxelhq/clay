...
class TestHTTPCallback(TestCase):
    ...
    def test_init(self):
        ...
        callback3 = HTTPCallback(callback_endpoint=self.callback_url, headers={"Content-Type": "text/plain"})
    ...
    def test_send_callback_success_status_codes(self, mock_post):
        ...
        callback_data = CallbackData(
            id="test-123", progress=50.0, inputs=[{"name": "input1", "value": "test"}], metadata={"version": "1.0"}
        )
    ...
    def test_send_callback_failure(self, mock_post):
        ...
        callback_data = CallbackData(id="error-test", inputs=[{"name": "input1", "value": "test"}], metadata={})
    ...
    def test_send_callback_exception(self, mock_post):
        ...
        callback_data = CallbackData(id="exception-test", inputs=[{"name": "input1", "value": "test"}], metadata={})
    ...
    def test_send_unified(self, mock_send):
        ...
        result = self.callback.send(
            id=test_id, inputs=test_inputs, metadata=test_metadata, logger=self.logger, progress=test_progress
        )
    ...
    def test_send_progress(self, mock_send):
        ...
        result = self.callback.send_progress(
            id=test_id, progress=test_progress, inputs=test_inputs, metadata=test_metadata, logger=self.logger
        )
