...
### Fixes
- Correct sorting while listing of blocks
- Removed any env specific flag from clay cli

## v0.6.1 - 05-02-2025
### New Features
-  Notice for deprecation of Types in clay
### Fixes
-  Return kind and type in all get block APIs
-  Clay registry host updated in github publish pipeline
