...
If you don't statisfy any of these criterias, you probably already know all of these. Inspite of this, you are more than welcome to carry-on!
...
* **Infrastructure**: Engineer-speak for hotch-potch of servers, networks, gateways and some other buzzwords. Generally located in `us-east-2`. All our software runs on these things (Atleast most of it). Oh and they are very expensive.

* **Kubernetes**: A magical software that manages and runs all our software.

* **Cluster**: A (mostly) isolated version of *kubernetes* that runs different versions of our software. There are essentially *three clusters* - **dev**, **staging** and **production**.

    1. *Dev Cluster*: Well, it's for devs. Any software written first gets deployed here. Usually this doensn't work most of the times.

    2. *Staging Cluster*: Post a lot of fixing, software deployed earlier in dev, gets promoted to staging. Usually works.

    3. *Production Cluster*: Well, this is the final stage and ideally everything *should* work.

* **Orchestrator**: A service that manages and runs all ML related features on Auorora.
