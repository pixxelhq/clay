...
init-requirements:	generate-secrets
			pip install pixxel-datatypes -r python/requirements/requirements-dev.txt --extra-index-url https://aws:$$(cat )@REDACTED.d.codeartifact.us-east-2.amazonaws.com/pypi/python/simple/
