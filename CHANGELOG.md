...
## v0.5.0 - 2024-09-11
### New Features
- Added `group` support to data spec — @pranjaldatta. [043af0d](https://github.com/pixxelhq/clay-framework/commit/043af0d7b7d2ef6067fa0fbbe7effb4c7a6b7016)
### Fixes
- Input vector files now get uploaded to S3 for both inferences and workflows — @sanafirdaus. [eb435f0](https://github.com/pixxelhq/clay-framework/commit/eb435f0082ae8be1e261b5b1c743484f082f2b3f)

## v0.4.11 - 2024-08-14
### New Features
- Orchestrator callback URL is now configurable and injected at runtime — @pranjaldatta. [4107ed6](https://github.com/pixxelhq/clay-framework/commit/4107ed6e546772a5bf14ecabe8b04bbb70d994e5)

## v0.4.10 - 2024-07-23
### New Features
- Support for stac URLs in `RasterProperties` — @pranjaldatta. [4f0031e](https://github.com/pixxelhq/clay-framework/commit/4f0031e229c5d516a9e79c080eac6a13b9862761)

## v0.4.6 - 2024-06-28
### New Features
- Added `date` to `RasterProperties` — @sanafirdaus. [6e50abd](https://github.com/pixxelhq/clay-framework/commit/6e50abd875d95b5e886af307a1e8f26cd44ec078)
- Added time metrics to inference callback — @pranjaldatta. [c3c192b](https://github.com/pixxelhq/clay-framework/commit/c3c192b16f3863453c0580bf8b83c767143f97b0)
### Fixes
- Improved time calculation for total block runtime and inference runtime — @pranjaldatta. [d2c7510](https://github.com/pixxelhq/clay-framework/commit/d2c751086cc6fe8deea73f266804a315bf3ed9f0)
